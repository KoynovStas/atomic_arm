...
void* test_sem_thread1(void *thread_arg)
{
...
void* test_sem_thread2(void *thread_arg)
{
...
int main(void)
{
    ...
    if( sem_init(&test_sem, 0, 1) != 0)
        perror_exit("Cant init sem");



    printf("run sem test threads, wait...\n\n");
    run_test(test_sem_thread1, test_sem_thread2);
